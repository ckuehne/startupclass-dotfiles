...
;; ckuehne: set to "js" to be compatible with js-comint where it is hard-coded
(defvar nodejs-repl-process-name "js"
  "process name of Node.js REPL. 
   ckuehne: Set to 'js' to be compatible
   with js-comint where 'js' is the hard-coded name for the node-repl
   buffer")
